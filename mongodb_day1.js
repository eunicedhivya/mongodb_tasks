...
// output
// { "_id" : null, "keys" : [ "_id", "product_price", "id", "product_material", "product_color", "product_name" ] }
// Above code indicates that the information available in the collection is id, price, color, material, name
